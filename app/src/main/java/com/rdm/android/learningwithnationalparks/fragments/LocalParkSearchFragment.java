...
public class LocalParkSearchFragment extends Fragment implements OnMapReadyCallback,
	...
	SupportMapFragment localMapFragment;
...
//	    });
	...
	public void onMapReady(GoogleMap googleMap) {
		...
		mMap.setInfoWindowAdapter(new LocalInfoWindowAdapter(getLayoutInflater(), getContext()));
			...
			public void onInfoWindowClick(Marker marker) {
				...
				if (marker.getTag() == "localPark") {
					...
					getChildFragmentManager().beginTransaction()
							.replace(R.id.frame_park_search_local_layout, streetViewFragment, "panoramaFragment")
							...
							panorama.setOnStreetViewPanoramaChangeListener(new StreetViewPanorama.OnStreetViewPanoramaChangeListener() {
								...
								public void onStreetViewPanoramaChange(StreetViewPanoramaLocation streetViewPanoramaLocation) {
									if (streetViewPanoramaLocation != null && streetViewPanoramaLocation.links != null) {
										...
										Toast.makeText(getActivity(), "Panorama view not available at this marker :( ", Toast.LENGTH_LONG).show();
									}
								}
							});
						}
