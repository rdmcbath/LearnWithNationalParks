...
public interface RetrofitFlickr {
    ...
    //[MYAPIKEY]&user_id=42600860@N02&extras=url_o,description&format=json&nojsoncallback=1

    @GET("rest/?method=flickr.people.getPhotos&api_key=[MYAPIKEY]&user_id=42600860%40N02&extras=url_z,description&format=json&nojsoncallback=1")
    ...
    @GET("rest/?method=flickr.groups.pools.getPhotos&api_key=[MYAPIKEY]&group_id=57347939@N00&extras=url_c,description&format=json&nojsoncallback=1")
	...
	@GET("rest/?method=flickr.groups.pools.getPhotos&api_key=[MYAPIKEY]&group_id=39889516@N00&extras=url_c,description&format=json&nojsoncallback=1")
